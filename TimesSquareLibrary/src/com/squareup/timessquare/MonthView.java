...
public class MonthView extends LinearLayout {
	...
	public static MonthView create(ViewGroup parent, LayoutInflater inflater,
		...
		for (int offset = 0; offset < 7; offset++) {
			...
			textView.setText(WeekFormatChange.format(weekdayNameFormat
	...
	public void init(MonthDescriptor month,
		...
		String[] labels=month.getLabel().split("年");
		if(labels != null && labels.length==2){
			labels[1]="<font color='#7a4427'>"+labels[1]+"</font>";
			String htmlLabel=labels[0]+"年"+labels[1];
			title.setText(Html.fromHtml(htmlLabel));
		}else {
